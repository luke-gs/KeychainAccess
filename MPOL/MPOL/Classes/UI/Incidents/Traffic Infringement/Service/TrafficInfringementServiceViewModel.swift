...
public class TrafficInfringementServiceViewModel {
    ...
    var people: [Person] {
        ...
        let entities = report.event?.incidentRelationshipManager?.relationships(for: incident).compactMap {
            return report.event?.entityBucket.entity(for: $0.baseObjectUuid)
        }
