...
public class PopoverFormSheetPresentationController: UIPresentationController, UIViewControllerAnimatedTransitioning {
    ...
    public func transitionDuration(using transitionContext: UIViewControllerContextTransitioning?) -> TimeInterval {
        return transitionContext?.isAnimated ?? true ? 0.45 : 0.0
    }
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        UIView.animate(withDuration: transitionDuration, delay: 0.0, usingSpringWithDamping: isPresenting ? 0.7 : 1.0, initialSpringVelocity: 0.0, animations: {
            if isPresenting {
