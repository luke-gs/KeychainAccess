...
s.name             = 'MPOLKit'
s.version          = '0.1.0'
s.summary          = 'A short description of MPOLKit.'
...
s.homepage         = 'https://github.com/val@gridstone.com.au/MPOLKit'
# s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
s.license          = { :type => 'MIT', :file => 'LICENSE' }
s.author           = { 'val@gridstone.com.au' => 'val@gridstone.com.au' }
s.source           = { :git => 'https://github.com/val@gridstone.com.au/MPOLKit.git', :tag => s.version.to_s }
