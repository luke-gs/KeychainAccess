...
public struct NetworkRequest: NetworkRequestType {
    ...
    public init(pathTemplate: String, parameters: [String: Any], method: HTTPMethod = .get, parameterEncoding: ParameterEncoding = URLEncoding.default, headers: [String : String]? = nil, isRelativePath: Bool = true) throws {
