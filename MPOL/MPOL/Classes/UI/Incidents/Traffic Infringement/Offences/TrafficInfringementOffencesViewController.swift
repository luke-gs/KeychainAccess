...
open class TrafficInfringementOffencesViewController: FormBuilderViewController, EvaluationObserverable {
    ...
    open override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            totalsView.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor),
    ...
    override open func construct(builder: FormBuilder) {
        ...
        viewModel.report.offences.forEach { offence in
            ...
            builder += SubtitleFormItem()
                ...
                .editActions([CollectionViewFormEditAction(title: "Remove", color: UIColor.red, handler: { (_, indexPath) in
