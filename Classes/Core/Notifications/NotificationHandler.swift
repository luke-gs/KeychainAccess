...
public protocol NotificationHandler: class {
    ...
    // Note: If a silent notification ("content-available": 1) is sent together with an alert key,
    // both handleSilentNotification and handleForegroundNotification will be called
